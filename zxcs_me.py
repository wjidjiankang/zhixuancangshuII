...
def get_max():
    ...
    :return:
    """
    url_oringal = 'http://zxcs.me/'
    response = ask_url(url_oringal)
    response.encoding = 'utf8'
    html = etree.HTML(text=response.text)
    max_url = html.xpath('/html/body/div[5]/div[1]/div[2]/ul/li[1]/a/@href')
...
def dealData (start,number):
    ...
    for i in range(start,int(number)):
        ...
        try:
            ...
            print("can not find the page {}".format(i))
            continue
    return result
